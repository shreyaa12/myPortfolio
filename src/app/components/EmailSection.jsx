...
//           <Link href="https://github.com/shreyaa12/">
//             <Image src={GithubIcon} alt="Github Icon" />
//           </Link>
//           <Link href="https://www.linkedin.com/in/shreyagokani31/">
...
//             <button
//               type="submit"
//               className="bg-white hover:bg-primary text-black font-medium py-2.5 px-5 rounded-lg w-full"
//             >
//               Send Message
//             </button>
//           </form>
...
const EmailSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const JSONdata = JSON.stringify(data);
    const endpoint = "/api/email"; // Corrected endpoint
